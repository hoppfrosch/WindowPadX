...
;
; Original: http://www.autohotkey.com/forum/viewtopic.php?t=48668
; Ext01 : http://www.autohotkey.com/forum/viewtopic.php?p=423062#423062 - ScrollBar
; Ext02 : http://www.autohotkey.com/forum/viewtopic.php?p=445173#445173 - Fixed Size
...
Notify(Title="!!!",Message="",Duration=30,Options="",Image="")
{
 ...
 static GWmin := 100 ;  [Added by sumon] Gui Custom Width (min)
 static GWmax := 800 ; [Added by sumon] Gui Custom Width (max)
...
If (GW < GWmin) ; [sumon] Sets width to custom, if it is outside of custom range
 {
  Gui, %GN%:Show, Hide w%GWmin%, NotifyGui
  Gui  %GN%:+LastFound
 WinGetPos, GX, GY, GW, GH
 }
 If (GW > GWmax)
 {
  Gui, %GN%:Show, Hide w%GWmax%, NotifyGui
  Gui %GN%:+LastFound
  WinGetPos, GX, GY, GW, GH
 }
